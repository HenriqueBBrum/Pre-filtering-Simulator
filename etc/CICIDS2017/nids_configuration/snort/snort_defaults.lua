...
HTTP_PORTS =
[[
    36 80 81 82 83 84 85 86 87 89 90 311 383 443 555 591 593 631 801 808 818 901 972 1158 1220 1414 1533 1581 1719 1720 1741 1801 1830 1942 2231 
    2301 2375 2381 2578 2809 2869 2980 3000 3029 3037 3057 3128 3443 3702 4000 4343 4592 4848 5000 5054 5060 5061 5117 5222 5250 5416 5443 5450 
    5555 5600 5814 5894 5984 6080 6173 6988 7000 7001 7005 7070 7071 7144 7145 7180 7181 7510 7770 7777 7778 7779 8000 8001 8008 8009 8014 8015 8020 8028
    8040 8080 8081 8082 8085 8088 8090 8095 8118 8123 8180 8181 8182 8243 8280 8300 8222 8243 8280 8300 8333 8344 8393 8400 8443 8484 8500 8509 8694 8787 8800
    8852 8880 8888 8899 8983 9000 9002 9060 9080 9090 9091 9111  9200 9201 9290 9443 9447 9700 9710 9788 9830 9850 9999 10000 10080 10100 10250 10255 10297 10443 11371
    12601 13014 14592 15489 16000 17000 18081 19980 29991 30007 30018 33300 34287 34412 34443 34444 36099 40007 41080 44449 49152 49153 50000 50002 50452 51423 53331 55252 55555 56712
]]
...
default_classifications =
{
  ...
  },
  {
      ...
      text = 'Targeted Malicious Activity was Detected',
      priority = 1,
  },
  {
      name = 'exploit-kit',
      text = 'Exploit Kit Activity Detected',
      priority = 1,
  },
  {
      name = 'external-ip-check',
      text = 'Device Retrieving External IP Address Detected',
      priority = 2,
  },
  {
      name = 'domain-c2',
      text = 'Domain Observed Used for C2 Detected',
      priority = 1,
  },
  {
      name = 'pup-activity',
      text = 'Possibly Unwanted Program Detected',
      priority = 2,
  },
  {
      name = 'credential-theft',
      text = 'Successful Credential Theft Detected',
      priority = 1,
  },
  {
      name = 'social-engineering',
      text = 'Possible Social Engineering Attempted',
      priority = 2,
  },
  {
      name = 'coin-mining',
      text = 'Crypto Currency Mining Activity Detected',
      priority = 2,
  },
  {
      name = 'command-and-control',
      text = 'Malware Command and Control Activity Detected',
      priority = 1,
  },
}
