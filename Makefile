...
simulation.community: 
	python3 src/main.py ${SNORT_CONFIG} ${SNORT_COMMUNITY_RULES} community ${SCENARIO}  2>&1 |  tee suspicious_packets/${SCENARIO}/community/log.txt

simulation.registered:
	python3 src/main.py ${SNORT_CONFIG} ${SNORT3_REGISTERED_RULES} registered ${SCENARIO}  2>&1 |  tee suspicious_packets/${SCENARIO}/registered/log.txt